...
% Version 2.4. See http://terpconnect.umd.edu/~toh/spectrum/iSignal.html
...
%             [xx,yy]=RedrawSignal(X,Y,xo,dx);
        ...
        case 107
            ...
            disp('KEYBOARD CONTROLS, version 2.4:')
...
plot(xx,yy,'b')
title('iSignal 2.4. Arrow keys to pan and zoom. Press K for keyboard commands')
lyy=min(yy);
