...
% press M and proceed as for the normal curve fit. This function may tale a
...
global PeakLabels PeakID Names Positions maxerror logplot plotcolor showpeak Sharpen
global SavedY 
format short g
format compact
warning off all
...
if isscalar(key),
  ...
  switch double(key),
    ...
    case 107
        ...
        disp('iPeak 4.1 KEYBOARD CONTROLS:')
...
switch AUTOZERO
    case 0
        if valleymode,
                title('iPeak 4.1.  Valley mode.    Autozero OFF.   Press K for keyboard commands')
        else
            if Sharpen,
                title('iPeak 4.1.  Sharpen mode.   Autozero OFF.   Press K for keyboard commands')
            else
                title('iPeak 4.1.  Peak mode.      Autozero OFF.   Press K for keyboard commands')
            end
        end
    case 1
        if valleymode,
                title('iPeak 4.1.  Valley mode.   Linear autozero.  Press K for keyboard commands')
        else
            if Sharpen,
                title('iPeak 4.1.  Sharpen mode.  Linear autozero.  Press K for keyboard commands')
            else
                title('iPeak 4.1.  Peak mode.     Linear autozero.  Press K for keyboard commands')
            end
        end
    case 2
        if valleymode,
                title('iPeak 4.1. Valley mode.  Quadratic autozero.  Press K for keyboard commands')
        else
            if Sharpen,
                title('iPeak 4.1. Sharpen mode. Quadratic autozero.  Press K for keyboard commands')
            else
                title('iPeak 4.1. Peak mode.    Quadratic autozero.  Press K for keyboard commands')
            end
        end  
end % switch
