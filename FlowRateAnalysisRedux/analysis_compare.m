...
%#
%# Description:  Plot data of repeated runs, save as PNG and carry out
%#               a single factor ANOVA statistic.
%#
%# -------------------------------------------------------------------------
%#
%# CHANGES    :  dd/mm/yyyy - ...
...
repeat_plot(timeData,resultsArrayWP,runArray,0,'CH_0 Wave Probe','Kg','CH_0_Wave_Probe',name)
%repeat_plot(timeData,resultsArrayKPStbd,runArray,meanRPMStbd,'CH_1 STBD Kiel Probe','V','CH_1_STBD_Kiel_Probe',name)
repeat_plot(timeData,resultsArrayKPPort,runArray,meanRPMPort,'CH_2 PORT Kiel Probe','V','CH_2_PORT_Kiel_Probe',name)
%repeat_plot(timeData,resultsArrayTStbd,runArray,meanRPMStbd,'CH_7 STBD Thrust','g','CH_7_STBD_Thrust',name)
repeat_plot(timeData,resultsArrayTPort,runArray,meanRPMPort,'CH_8 PORT Thrust','g','CH_8_PORT_Thrust',name)
%repeat_plot(timeData,resultsArrayQStbd,runArray,meanRPMStbd,'CH_9 STBD Torque','Nm','CH_9_STBD_Torque',name)
repeat_plot(timeData,resultsArrayQPort,runArray,meanRPMPort,'CH_10 PORT Torque','Nm','CH_10_PORT_Torque',name)