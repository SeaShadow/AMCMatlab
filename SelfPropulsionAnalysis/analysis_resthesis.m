%# ------------------------------------------------------------------------
%# Self-Propulsion Test Analysis: Final Tesis Results Plots
%# ------------------------------------------------------------------------
%#
...
%# ------------------------------------------------------------------------
%#
%# CHANGES    :  02/12/2014 - Created new script
%#               dd/mm/yyyy - ...
%#
%# ------------------------------------------------------------------------
...
enableNumber7Plot           = 1;    % Barplot showing Differences in results when
                                    % using ws=wm(CFs/CFm) or ws=wm(CFs/CFm)+(t+0.04)(1-CFs/CFm)
enableNumber8Plot           = 1;    % Wake fraction comparison
