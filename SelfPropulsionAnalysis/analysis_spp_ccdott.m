...
%# Annotations
% Text on plot
text(0.55,-0.75,'Legend:','FontSize',12,'color','k','FontWeight','bold');
text(0.55,-0.85,'MS = Model scale','FontSize',12,'color','k','FontWeight','normal');
text(0.55,-0.95,'FS = Full scale','FontSize',12,'color','k','FontWeight','normal');
